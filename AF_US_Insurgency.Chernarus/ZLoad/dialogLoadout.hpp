...
class zlo_LoadOut_Dialog
{
	...
	class zlo_rscBackround3: IGUIBack
	{
		...
		w = 0.422812 * safezoneW;
		h = 0.076 * safezoneH;
	colorBackground[] = {0.4,0.4,0.4,0.2};//0.2/0.5/0.5/1
	//12 53 21 1
	//31 31 31 1
	};
...
class zlo_copilot_00: RscPicture
{
	idc = 1214;
...
class zlo_copilot_01: RscPicture
{
	idc = 1201;
	x = 0.12875 * safezoneW + safezoneX;
...
class zlo_copilot_02: RscPicture
{
	idc = 1202;
	x = -0.12875 * safezoneW + safezoneX;
...
class zlo_copilot_03: RscPicture
{
	idc = 1203;
	x = -0.12875 * safezoneW + safezoneX;
...
class zlo_copilot_04: RscPicture
{
	idc = 1204;
	x = -0.12875 * safezoneW + safezoneX;
...
class zlo_copilot_05: RscPicture
{
	idc = 1205;
	x = -0.12875 * safezoneW + safezoneX;
...
class zlo_copilot_06: RscPicture
{
	idc = 1206;
	x = -0.12875 * safezoneW + safezoneX;
...
class zlo_copilot_07: RscPicture
{
	idc = 1207;
	x = -0.12875 * safezoneW + safezoneX;
...
class zlo_copilot_08: RscPicture
{
	idc = 1208;
	x = -0.12875 * safezoneW + safezoneX;
...
class zlo_copilot_09: RscPicture
{
	idc = 1209;
	x = -0.12875 * safezoneW + safezoneX;
	y = -0.478 * safezoneH + safezoneY;
...
class zlo_copilot_010: RscPicture
{
	idc = 1210;
...
class zlo_copilot_011: RscPicture
{
	idc = 1211;
	x = -0.17 * safezoneW + safezoneX;
	y = -0.28 * safezoneH + safezoneY;
...
class zlo_copilot_012: RscPicture
{
	idc = 1212;
	x = -0.17 * safezoneW + safezoneX;
	y = -0.324 * safezoneH + safezoneY;
...
class zlo_copilot_013: RscPicture
{
	idc = 1213;
	x = -0.17 * safezoneW + safezoneX;
	y = -0.324 * safezoneH + safezoneY;
...
class zlo_copilot_10: RscButton
{
	idc = 1618;
	x = -0.17 * safezoneW + safezoneX;
	y = -0.192 * safezoneH + safezoneY;
...
class zlo_copilot_11: RscButton
{
	idc = 1619;
	x = -0.17 * safezoneW + safezoneX;
	y = -0.28 * safezoneH + safezoneY;
...
class zlo_copilot_12: RscButton
{
	idc = 1620;
	x = -0.17 * safezoneW + safezoneX;
	y = -0.324 * safezoneH + safezoneY;
...
class zlo_copilot_13: RscButton
{
	idc = 1621;
	x = -0.17 * safezoneW + safezoneX;
	y = -0.324 * safezoneH + safezoneY;
